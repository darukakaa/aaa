...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="dropdown">
      <button class="btn btn-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false" style="margin-right: 10px; box-shadow: 2px 2px 1px grey; background-color: #2C5C52; color: white; border-radius: 50px;">
        Semester
      </button>
        ...
        <div class="col-lg-12 mx-auto">
          <div class="card rounded shadow border-0">
            <div class="card-body p-5 bg-white rounded">
              <button type="button" class="btn add-kelas" data-bs-toggle="modal" data-bs-target="#tambahkelas">Tambah Kelas</button>
              <form action="" method="">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td style="width: 150px;">
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#detailkelas">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="row">
              <div class="col-lg-3 col-md-4 label mb-4">Nama Kelas</div>
              <div class="col-lg-9 col-md-8">X IPA 1</div>
            </div>
            <div class="row">
              <div class="col-lg-3 col-md-4 label mb-4">Wali Kelas</div>
              <div class="col-lg-9 col-md-8">Hartatik</div>
            </div>
          </div>
        </div>
      </div>
            ...
            <form action="" method="">
              <div class="row mb-3">
                ...
                <div class="col-md-8 col-lg-9">
                  <input name="fullName" type="text" class="form-control" id="fullName" value="Hartatik S.Pd">
                </div>
              </div>
              <div class="row mb-3">
                <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Wali Kelas</label>
                <div class="col-md-8 col-lg-9">
                  <input name="fullName" type="text" class="form-control" id="fullName" value="X IPA 1">
                </div>
              </div>
            </form>
          </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body ">
            <center>
              ...
              <p>tersebut ?</p>
              <a href="kelas.php" class="btn" style="border-radius: 10px; background-color:#fff; ">Batal</a>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body ">
              <center>
                ...
                <a href="rapor-ipa-1.php" class="btn" style="border-radius: 10px; background-color:#fff; ">Batal</a>
