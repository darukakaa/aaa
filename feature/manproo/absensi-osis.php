...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="d-grid gap-2 d-md-block">
        <a class="btn" style="text-decoration: none;  box-shadow: 2px 2px 1px grey; border-radius: 50px;" href="osis.php">Kegiatan</a>
      <a class="btn" style="text-decoration: none;  box-shadow: 2px 2px 1px grey; border-radius: 50px;" href="anggota-osis.php">Anggota</a>
      <a class="btn" style="text-decoration: none; margin-right: 10px; box-shadow: 2px 2px 1px grey; background-color: #2C5C52; color: white; border-radius: 50px;" href="absensi-osis.php">Absen</a>
    </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body ">
              <center>
                ...
                <a href="absensi-osis.php" class="btn" style="border-radius: 10px; background-color:#fff; ">Batal</a>
