    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
		  ...
		  <li class="breadcrumb-item"><a href="#">Koleksi Fasilitas</a></li>
          <li class="breadcrumb-item active">Tambah Buku</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
	<div class="d-grid gap-2 d-md-block">
      <a class="btn" style="text-decoration: none; margin-right: 10px; box-shadow: 2px 2px 1px grey; background-color: #2C5C52; color: white; border-radius: 50px;" href="perpustakaan.php">Koleksi Buku</a>
	  ...
	  <a class="btn" style="text-decoration: none;  box-shadow: 2px 2px 1px grey; border-radius: 50px;" href="perpustakaan-bukuhilang.php">Buku Hilang</a>
    </div>
          ...
          <div class="col-lg-12 mx-auto">
            <div class="card rounded shadow border-0">
              <div class="card-body p-5 bg-white rounded">
				  <div class="d-grid gap-2 d-md-block">
					<a class="btn" style="text-decoration: none; margin-right: 10px; box-shadow: 2px 2px 1px grey; background-color: #2C5C52; color: white; border-radius: 50px;" href="perpustakaan-tambahbuku.html">Tambah Buku</a>
				  </div>
				  <br><br>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body ">
              <center>
                ...
                <a href="perpustakaan.php" class="btn" style="border-radius: 10px; background-color:#fff; ">Batal</a>
