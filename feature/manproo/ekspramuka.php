...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">Ekstrakulikuler</a></li>
    ...
    <div class="d-grid gap-2 d-md-block">
        <a class="btn" style="text-decoration: none; margin-right: 10px; box-shadow: 2px 2px 1px grey; background-color: #2C5C52; color: white; border-radius: 50px;" href="ekspramuka.php">Galeri</a>
        <a class="btn" style="text-decoration: none;  box-shadow: 2px 2px 1px grey; border-radius: 50px;" href="eksjadwal.php">Jadwal</a>
        <a class="btn" style="text-decoration: none;  box-shadow: 2px 2px 1px grey; border-radius: 50px;" href="eksanggota.php">Anggota</a>
        <a class="btn" style="text-decoration: none;  box-shadow: 2px 2px 1px grey; border-radius: 50px;" href="eksabsen.php">Absensi</a>
    </div>
          ...
          <div class="col-lg-12 mx-auto">
            <div class="card rounded shadow border-0">
              <div class="card-body p-5 bg-white rounded">
                <button type="button" class="btn add-kelas" data-bs-toggle="modal" data-bs-target="#tambahsiswa">Tambah Galeri</button>

                <div class="card mb-3">
                  <div class="row g-0">
                    <div class="col-md-4">
                      <img src="assets/img/Rectangle 26 (3).png" class="img-fluid rounded-start" alt="...">
                    </div>
                    <div class="col-md-8">
                      <div class="card-body">
                        <h5 class="card-title">Juara Umum Lomba Tegap Tangkas Penegak Tingkat Nasional Tahun 2022</h5>
                        <p class="card-text">Pramuka SMA UNGGULAN UNESA Ambalan Surajaya - Maharani berhasil meraih Juara Umum Lomba Tegap Tangkas Penegak Tingat Nasional Tahun 2022 yang diselenggarakan oleh Universitas Pembangunan Negara. Mengirimkan 2 tim dengan 1 tim putra dan 1 tim putri, mereka berhasil meraih juara baik 1, 2 maupun 3 di setiap mata perlombaan...</p>
              ...
              <div class="modal-dialog">
                <div class="modal-content" style="width: 650px;">
                  <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Tambah Galeri Baru</h1>
                  ...
                  <div class="modal-body">
                    <form>
                      ...
                      <div class="row mb-3" >
                        <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Judul</label>
                        <div class="col-md-8 col-lg-9">
                          <textarea name="fullName" type="text" class="form-control" id="fullName" value="" width="100px"></textarea>
                        </div>
                      </div>
                      ...
                      <div class="row mb-3" >
                        ...
                        <div class="col-md-8 col-lg-9">
                          <input name="fullName" type="text" class="form-control" id="fullName" value="" width="100px">
                        </div>
                      </div>
                      ...
                      <div class="row mb-3">
                        <label for="inputTime" class="col-md-4 col-lg-3 col-form-label">TimeStamp</label>
                        <div class="col-md-8 col-lg-9">
      ...
      <div class="modal fade" id="infoo" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable">
          <div class="modal-content" style="width: 650px;">
            ...
            <div class="modal-body">
            <h2 style="text-align:center;">Detail Absensi Siswa</h2>
            <div class="row">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body ">
              <center>
                ...
                <p>tersebut ?</p>
                <a href="absos.php" class="btn" style="border-radius: 10px; background-color:#fff; ">Batal</a>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body ">
              <center>
                ...
                <a href="ekspramuka.php" class="btn" style="border-radius: 10px; background-color:#fff; ">Batal</a>
