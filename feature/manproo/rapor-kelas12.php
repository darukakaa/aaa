...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><a href="rapor.php">Rapor</a></li>
          <li class="breadcrumb-item active">Rapor Kelas XII </li>
        ...
        <div class="col-lg-12 mx-auto">
          <div class="card rounded shadow border-0">
            <div class="card-body p-5 bg-white rounded">
              <button type="button" class="btn add-kelas" data-bs-toggle="modal" data-bs-target="#tambahrapor">Tambah Nilai</button>
              <div class="table-responsive">
                <table id="example" class="table table-striped " style="width:100%">
                  ...
                  <tbody>
                    <tr>
                      <td>01</td>
                      <td>Luluk Mukaromah</td>
                      <td>0001243201</td>
                      <td>1</td>
                      <td>1.234</td>
                      <td style="width: 150px;">
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#detailrapor">
                          <i class="bi bi-eye-fill" style="width: 10px ;"></i>
                        </button>
                        <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#editrapor">
    ...
    <!-- modal detail-->
    <div class="modal fade" id="detailrapor" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="row">
              <div class="col-lg-6 col-md-8 label mb-4">Nama Siswa</div>
            </div>
            <div class="row">
              <div class="col-lg-6 col-md-8 label mb-4">NISN </div>
            </div>
            <div class="row">
              <div class="col-lg-6 col-md-8 label mb-4">Peringkat</div>
            </div>
            <div class="row">
              <div class="col-lg-6 col-md-8 label mb-4">Jumlah Nilai </div>
            </div>
          </div>
        </div>
      </div>
    ...
    <!-- modal tambah -->
    <div class="modal fade" id="tambahrapor" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h1 class="modal-title fs-5" id="exampleModalLabel">Tambah Data Rapor</h1>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
            <form action="" method="">
              <div class="row mb-3">
                <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Nama Siswa</label>
              ...
              <div class="row mb-3">
                <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Peringkat</label>
                <div class="col-md-8 col-lg-9">
                  <input name="fullName" type="text" class="form-control" id="fullName" value="">
                </div>
              </div>
              <div class="row mb-3">
                <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Jumlah Nilai</label>
                <div class="col-md-8 col-lg-9">
                  <input name="fullName" type="text" class="form-control" id="fullName" value="">
                </div>
              </div>
    ...
    <!-- modal edit -->
    <div class="modal fade" id="editrapor" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h1 class="modal-title fs-5" id="exampleModalLabel">Tambah Data Rapor</h1>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body ">
            <center>
              ...
              <p>tersebut ?</p>
              <a href="rapor-kelas12.php" class="btn" style="border-radius: 10px; background-color:#fff; ">Batal</a>
