...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><a href="berita-xipa1.php">Berita</a></li>
          <li class="breadcrumb-item active">Berita Kelas X IPA 1 </li>
    ...
    <div class="d-grid gap-2 d-md-block">
      <a class="btn" style="text-decoration: none; margin-right: 10px; box-shadow: 2px 2px 1px grey; background-color: #2C5C52; color: white; border-radius: 50px;" href="berita-kelas.php">Kelas</a>
      <a class="btn" style="text-decoration: none;  box-shadow: 2px 2px 1px grey; border-radius: 50px;" href="berita-sekolah.php">Sekolah</a>
    </div>
        ...
        <div class="col-lg-12 mx-auto">
          <div class="card rounded shadow border-0">
            <div class="card-body p-5 bg-white rounded">
              <button type="button" class="btn add-kelas" data-bs-toggle="modal" data-bs-target="#tambahberita">Tambah Berita</button>
              <div class="table-responsive">
                <table id="example" class="table table-striped " style="width:100%">
                  ...
                  <tbody>
                    <tr>
                      <td>01</td>
                      <td>Mata Pelajaran Kimia Akan Melaksanakan Praktek Minggu Depan</td>
                      <td>10/10/2022</td>
                      <td>Foto</td>
                      <td>Silakan pelajari buku halaman 21 - 30. dan rangkum materi di buku...</td>
                      <td>21/10/2022</td>
                      <td style="width: 150px;">
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#detailberita">
                          <i class="bi bi-eye-fill" style="width: 10px ;"></i>
                        </button>
                        <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#editberita">
    ...
    <!-- modal detail-->
    <div class="modal fade" id="detailberita" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h1 class="modal-title fs-5" id="exampleModalLabel"> Detail Rapor</h1>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
            <div class="row">
              <div class="col-lg-6 col-md-8 label mb-4">Judul Berita</div>
            </div>
            <div class="row">
              <div class="col-lg-6 col-md-8 label mb-4">Tanggal Rilis </div>
            </div>
            <div class="row">
              <div class="col-lg-6 col-md-8 label mb-4">Dokumentasi</div>
            </div>
            <div class="row">
              <div class="col-lg-6 col-md-8 label mb-4">Deskripsi</div>
            </div>
            <div class="row">
              <div class="col-lg-6 col-md-8 label mb-4">Timestamp</div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="" method="">
              ...
              <div class="row mb-3">
                <label for="profileImage" class="col-md-4 col-lg-3 col-form-label">Dokumentasi</label>
                <div class="col-md-8 col-lg-9">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body ">
            <center>
              ...
              <p>tersebut ?</p>
              <a href="berita-kelas10.php" class="btn" style="border-radius: 10px; background-color:#fff; ">Batal</a>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body ">
              <center>
                ...
                <a href="berita-xipa1.php" class="btn" style="border-radius: 10px; background-color:#fff; ">Batal</a>
