    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><a href="berita-kelas.php">Berita</a></li>
          <li class="breadcrumb-item active">Berita Kelas XII </li>
        </ol>
      </nav>
    </div>
    <!-- End Page Title --> 
        ...
        <div class="modal-content">
          ...
          <div class="modal-body ">
            <center>
              ...
              <p>tersebut ?</p>
              <a href="berita-kelas12.php" class="btn" style="border-radius: 10px; background-color:#fff; ">Batal</a>
