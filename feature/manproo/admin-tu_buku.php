...
<body>
  ...
  <main id="main" class="main">
   ...
   <div class="d-grid gap-2 d-md-block">
	  ...
	  <a class="btn" style="text-decoration: none; margin-right: 10px; box-shadow: 2px 2px 1px grey; background-color: #2C5C52; color: white; border-radius: 50px;" href="admin-tu_buku.php">Buku</a>
	...
	<div class="col-lg-12">
        <div class="row">
            <div class="col-xxl-2 col-md-4">
                <a href="admin-tu_buku_XII-IPS-1.php">
                    <div class="card-kelas1" style="width: 15rem;">
                        <div class="card-body">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body ">
              <center>
                ...
                <a href="admin-tu_buku.php" class="btn" style="border-radius: 10px; background-color:#fff; ">Batal</a>
