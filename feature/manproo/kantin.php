        ...
        <div class="col-lg-12 mx-auto">
          <div class="card rounded shadow border-0">
            <div class="card-body p-5 bg-white rounded">
              ...
              <div class="row">
                <div class="col-md-4">
                  <a href="kantin-kelengkeng.php">
                    <div class="card" style="width: 15rem; background-color: #6EA597; /* For browsers that do not support gradients */
                    background-image: linear-gradient(to bottom right, #6EA597, #fff);">
                    <div class="card-body">
                      <h5 class="card-title" style="color: black; font-size: 30px; padding-bottom: -10px;">X IPA 1</h5>
                      <p style="color:black; font-size: 20px;">Kantin Kelengkeng</p>
                      <center><img src="assets/img/buah.png" ></center>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-lg-6 col-md-8 label mb-4">Nomor</div>
        </div>
        <div class="row">
          <div class="col-lg-6 col-md-8 label mb-4">Nama Kantin </div>
        </div>
        <div class="row">
          <div class="col-lg-6 col-md-8 label mb-4">Pemilik </div>
        </div>
      </div>
    </div>
  </div>
...
<div class="modal fade" id="editkantin" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Edit Data Kantin</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form action="" method="">
          <div class="row mb-3">
            <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Nomor</label>
            <div class="col-md-8 col-lg-9">
              <input name="fullName" type="text" class="form-control" id="fullName" value="Mirna Milasari">
            </div>
          </div>
          <div class="row mb-3">
            <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Nama Pemilik</label>
            <div class="col-md-8 col-lg-9">
              <input name="fullName" type="text" class="form-control" id="fullName" value="Mirna Milasari">
            </div>
          </div>
          <div class="row mb-3">
            <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Pemilik</label>
            <div class="col-md-8 col-lg-9">
              <input name="fullName" type="text" class="form-control" id="fullName" value="Mirna Milasari">
            </div>
          </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="" method="">
          ...
          <div class="row mb-3">
            <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Nama Kantin</label>
            <div class="col-md-8 col-lg-9">
              <input name="fullName" type="text" class="form-control" id="fullName" value="">
            </div>
          </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body ">
              <center>
                ...
                <a href="kantin.php" class="btn" style="border-radius: 10px; background-color:#fff; ">Batal</a>
