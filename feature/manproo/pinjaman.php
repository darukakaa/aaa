...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="d-grid gap-2 d-md-block">
      <a class="btn" style="text-decoration: none;  box-shadow: 2px 2px 1px grey; border-radius: 50px;" href="fasilitas.php">Koleksi Fasilitas</a>
      <a class="btn" style="text-decoration: none; margin-left:20px; box-shadow: 2px 2px 1px grey; background-color: #2C5C52; color: white; border-radius: 50px;"  href="pinjaman.php">Pinjaman</a>
    </div>
    ...
    <div class="container table-responsive">
          ...
          <div class="col-lg-12 mx-auto">
            <div class="card rounded shadow border-0">
              <div class="card-body p-5 bg-white rounded">
                <button type="button" class="btn add-kelas" data-bs-toggle="modal" data-bs-target="#tambahpinjaman">Tambah Peminjaman</button>
                <button type="button" class="btn add-kelas" style="margin-left:20px;" >Cetak Laporan</button>
      ...
      <!-- modal -->
      <div class="modal fade" id="tambahpinjaman" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body ">
              <center>
                ...
                <a href="pinjaman.php" class="btn" style="border-radius: 10px; background-color:#fff; ">Batal</a>
