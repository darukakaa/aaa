...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Data Pembelian Fasilitas</h1>
      <nav>
        <ol class="breadcrumb">
    ...
    <div class="d-grid gap-2 d-md-block">
	  ...
	  <a class="btn" style="text-decoration: none; margin-right: 10px; box-shadow: 2px 2px 1px grey; background-color: #2C5C52; color: white; border-radius: 50px;" href="admin-tu_fasilitas.php">Fasilitas</a>
        ...
        <div class="row py-5">
          <div class="col-lg-12 mx-auto">
            <div class="card rounded shadow border-0">
			  ...
			  <div class="d-grid gap-2 d-md-block">
				  <a class="btn" style="text-decoration: none; margin-right: 10px; box-shadow: 2px 2px 1px grey; background-color: #2C5C52; color: white; border-radius: 50px;" href="#">Tambah Transaksi</a>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body ">
              <center>
                ...
                <a href="admin-tu_fasilitas.php" class="btn" style="border-radius: 10px; background-color:#fff; ">Batal</a>
