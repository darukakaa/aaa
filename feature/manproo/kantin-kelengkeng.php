...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="ppdb.php">
  ...
  <main id="main" class="main">
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">Kantin</li>
          <li class="breadcrumb-item ">Kantin Kelengkeng</li>
    ...
    <div class="d-grid gap-2 d-md-block" style="margin-bottom: 30px;">
      <a class="btn" style="text-decoration: none; margin-right: 10px; box-shadow: 2px 2px 1px grey; background-color: #2C5C52; color: white; border-radius: 50px;" href="kantin-kelengkeng.php">Menu</a>
      <a class="btn" style="text-decoration: none;  box-shadow: 2px 2px 1px grey; border-radius: 50px;" href="transaksi-menu.php">Transaksi</a>
    </div>
        ...
        <div class="col-lg-12 mx-auto">
          <div class="card rounded shadow border-0">
            <div class="card-body p-5 bg-white rounded">
              <button type="button" class="btn add-kelas" data-bs-toggle="modal" data-bs-target="#tambahkantin">Tambah Kantin</button>
              <div class="row">
                <div class="col-lg-3">
                 <a href="#">
                  <div class="card" style="width: 13rem; ">
                    <center><img src="assets/img/geprek.png" class="card-img-top" style="width:50%; margin-top:10px"></center>
                    <div class="card-body">
                      <h5 class="card-title" style="color:#000; font-size: 15px" >Ayam Geprek</h5>
                      <p style="margin-top:-10px; color:#000; font-size: 13px">Rp. 10.000</p>
                      <a href="#" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#detailkantin"><i class="bi bi-eye"></i></a>
                      <a href="#" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#editkantin"><i class="bi bi-pencil"></i></a>
                      <a href="#" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#hapuskantin"><i class="bi bi-trash"></i></a>
                    </div>
                  </div>
                </a>
              </div>
...
<div class="modal fade" id="tambahkantin" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel"> Tambah Kantin</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form>
          <div class="row mb-3">
            <label for="profileImage" class="col-md-4 col-lg-3 col-form-label">Foto Menu</label>
            <div class="col-md-8 col-lg-9">
              <img src="assets/img/geprek.png" alt="">
              <div class="pt-2">
          ...
          <div class="row mb-3">
            <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Nama Menu</label>
            <div class="col-md-8 col-lg-9">
          ...
          <div class="row mb-3">
            <label for="Phone" class="col-md-4 col-lg-3 col-form-label">Harga</label>
            <div class="col-md-8 col-lg-9">
...
<div class="modal fade" id="detailkantin" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Detail Kantin</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form action="" method="">
          ...
          <div class="row mb-3">
            <div class="col-lg-3 col-md-4 label">Nama Menu</div>
            <div class="col-lg-9 col-md-8">Nasi Geprek</div>
          </div>

          <div class="row mb-3">
            <div class="col-lg-3 col-md-4 label">Kategori</div>
            <div class="col-lg-9 col-md-8">Makanan</div>
          </div>

          <div class="row mb-3">
            <div class="col-lg-3 col-md-4 label">Harga</div>
            <div class="col-lg-9 col-md-8">Rp. 10.000</div>
          </div>
...
<div class="modal fade" id="editkantin" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel"> Tambah Kantin</h1>
...
<!-- modal hapus -->
<div class="modal fade" id="hapuskantin" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body ">
              <center>
                ...
                <a href="kantin-kelengkeng.php" class="btn" style="border-radius: 10px; background-color:#fff; ">Batal</a>
