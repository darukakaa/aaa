...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Mutasi Pegawai Masuk</li>
        </ol>
      </nav>
    </div>
    <!-- End Page Title -->
    ...
    <div class="d-grid gap-2 d-md-block">
      <a class="btn" style="text-decoration: none; margin-right: 10px; box-shadow: 2px 2px 1px grey; background-color: #2C5C52; color: white; border-radius: 50px;" href="mutasipegmasuk.php">Mutasi Masuk</a>
      <a class="btn" style="text-decoration: none;  box-shadow: 2px 2px 1px grey; border-radius: 50px;" href="mutasipegkeluar.php">Mutasi Keluar</a>
    </div>
            ...
            <div class="modal fade" id="tambahpengajuan" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog modal-dialog-scrollable">
                <div class="modal-content" style="width: 650px;">
                  ...
                  <h2 style="text-align:center;">Tambah Pengajuan Mutasi Pegawai Masuk</h2>
                    <form>
                      <div class="row mb-3">
              ...
              <!-- modal Edit Pengajuan Mutasi pegawai -->
          ...
          <div class="modal-content">
            ...
            <div class="modal-body ">
              <center>
                ...
                <a href="mutasipegmasuk.php" class="btn" style="border-radius: 10px; background-color:#fff; ">Batal</a>
