    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Penilaian Belajar Kelas XI</li>
        </ol>
      </nav>
    </div>
    <!-- End Page Title --> 
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h1 class="modal-title fs-5" id="exampleModalLabel"> Detail Penilaian</h1>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
            <div class="row">
              <div class="col-lg-6 col-md-8 label mb-4">Mata Pelajaran</div>
            </div>
            <div class="row">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body ">
              <center>
                ...
                <a href="penilaian-kelas11.php" class="btn" style="border-radius: 10px; background-color:#fff; ">Batal</a>
