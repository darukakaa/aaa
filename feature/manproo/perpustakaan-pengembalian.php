...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="d-grid gap-2 d-md-block">
	  ...
	  <a class="btn" style="text-decoration: none; margin-right: 10px; box-shadow: 2px 2px 1px grey; background-color: #2C5C52; color: white; border-radius: 50px;" href="perpustakaan-pengembalian.php">Pengembalian</a>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body ">
              <center>
                ...
                <a href="perpustakaan-pengembalian.php" class="btn" style="border-radius: 10px; background-color:#fff; ">Batal</a>
