...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">E-Saku</li>
        </ol>
      </nav>
    </div>
    <!-- End Page Title -->
   ...
   <div class="d-grid gap-2 d-md-block">
	  ...
	  <a class="btn" style="text-decoration: none; margin-right: 10px; box-shadow: 2px 2px 1px grey; background-color: #2C5C52; color: white; border-radius: 50px;" href="admin-tu_E-saku.php">E-Saku</a>
            ...
            <div class="col-xxl-2 col-md-4">
                <a href="#">
                    <div class="card-kelas1" style="width: 15rem;">
                        <div class="card-body">
							<p class="card-text" style="color: black; font-size: 30px; margin-top: -20px;"><b>Top Up</b></p>
                        <p class="card-text" style="color: white; font-size: 45px; margin-top: -20px;"><b>Saldo</b></p>
                        </div>
                    </div>
                </a>
            </div>
            ...
            <div class="col-xxl-2 col-md-4">
                <a href="#">
                    <div class="card-kelas2" style="width: 15rem;">
                        <div class="card-body">
						<p class="card-text" style="color: black; font-size: 30px; margin-top: -20px;"><b>Laporan</b></p>
                          <p class="card-text" style="color: white; font-size: 45px; margin-top: -20px;"><b>Saldo</b></p>
                        </div>
                    </div>
                </a>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body ">
              <center>
                ...
                <a href="admin-tu_E-saku.php" class="btn" style="border-radius: 10px; background-color:#fff; ">Batal</a>
