...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Buku Hilang</li>
        </ol>
      </nav>
    </div>
    <!-- End Page Title -->
    ...
    <div class="d-grid gap-2 d-md-block">
     <a class="btn" style="text-decoration: none;  box-shadow: 2px 2px 1px grey; border-radius: 50px;" href="perpustakaan.php">Koleksi Buku</a>
      <a class="btn" style="text-decoration: none;  box-shadow: 2px 2px 1px grey; border-radius: 50px;" href="perpustakaan-peminjaman.php">Peminjaman</a>
	  <a class="btn" style="text-decoration: none;  box-shadow: 2px 2px 1px grey; border-radius: 50px;" href="perpustakaan-pengembalian.php">Pengembalian</a>
	  <a class="btn" style="text-decoration: none;  box-shadow: 2px 2px 1px grey; border-radius: 50px;" href="perpustakaan-donasibuku.php">Donasi Buku</a>
	  <a class="btn" style="text-decoration: none; margin-right: 10px; box-shadow: 2px 2px 1px grey; background-color: #2C5C52; color: white; border-radius: 50px;" href="perpustakaan-bukuhilang.php">Buku Hilang</a>
    </div>
        ...
        <div class="row py-5">
          <div class="col-lg-12 mx-auto">
            <div class="card rounded shadow border-0">
			  ...
			  <div class="d-grid gap-2 d-md-block">
				  <a class="btn" style="text-decoration: none; margin-right: 10px; box-shadow: 2px 2px 1px grey; background-color: #2C5C52; color: white; border-radius: 50px;" href="#">Tambah Data</a>
                        ...
                        <tbody>
                            <tr>
                              <td>01</td>
                                ...
                                <td>30/10/2022</td>
                                <td>Edin</td>
                                <td>Kamus Inggris Indonesia</td>
                                <td>John M. Echols dan Hassan Shadily</td>
									<td>Kamus</td>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body ">
              <center>
                ...
                <a href="perpustakaan-bukuhilang.php" class="btn" style="border-radius: 10px; background-color:#fff; ">Batal</a>
