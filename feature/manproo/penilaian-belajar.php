    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Penilaian Belajar</li>
        </ol>
      </nav>
    </div>
    <!-- End Page Title --> 
          ...
          <div class="modal-content">
            ...
            <div class="modal-body ">
              <center>
                ...
                <a href="penilaian-belajar.php" class="btn" style="border-radius: 10px; background-color:#fff; ">Batal</a>
