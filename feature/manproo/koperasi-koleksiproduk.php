...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="koperasi-koleksiproduk.php">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Koleksi Produk</li>
        </ol>
      </nav>
    </div>
    <!-- End Page Title -->
    ...
    <div class="d-grid gap-2 d-md-block">
	  <a class="btn" style="text-decoration: none; margin-right: 10px; box-shadow: 2px 2px 1px grey; background-color: #2C5C52; color: white; border-radius: 50px;" href="koperasi-koleksiproduk.html">Koleksi Produk</a>
		<a class="btn" style="text-decoration: none;  box-shadow: 2px 2px 1px grey; border-radius: 50px;" href="koperasi-transaksi.php">Transaksi</a>
    </div>
        ...
        <div class="row py-5">
          <div class="col-lg-12 mx-auto">
            <div class="card rounded shadow border-0">
			  ...
			  <div class="d-grid gap-2 d-md-block">
				  <a class="btn" style="text-decoration: none; margin-right: 10px; box-shadow: 2px 2px 1px grey; background-color: #2C5C52; color: white; border-radius: 50px;" href="#">Tambah Produk</a>
				  </div>
				  <br><br>
                  ...
                  <div class="col-lg-3">
                   <a href="#">
                    ...
                    <center><img src="assets/img/proyektor.png" class="card-img-top" style="width:50%"></center>
                        <div class="card-body">
                          <h5 class="card-title" style="color:#000; font-size: 15px" >Buku Fisika Lingkungan</h5>
                          <p style="margin-top:-10px; color:#000; font-size: 13px">Rp 20.000,-</p>
                  ...
                  <div class="col-lg-3">
                   <a href="#">
                    ...
                    <center><img src="assets/img/kamera.png" class="card-img-top" style="width:50%"></center>
                        <div class="card-body">
                          <h5 class="card-title" style="color:#000; font-size: 15px" >Pensil Joyko 2B</h5>
                          <p style="margin-top:-10px; color:#000; font-size: 13px">Rp 2000,-</p>
                          <a href="#" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#detailfasilitas"><i class="bi bi-eye"></i></a>
                          <a href="#" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#editfasilitas"><i class="bi bi-pencil"></i></a>
                          <a href="#" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#hapusfasilitas"><i class="bi bi-trash"></i></a>
                        </div>
                  ...
                  <div class="col-lg-3">
                   <a href="#">
                    ...
                    <center><img src="assets/img/sound.png" class="card-img-top" style="width:50%"></center>
                        <div class="card-body">
                          <h5 class="card-title" style="color:#000; font-size: 15px" >Pulpem</h5>
                          <p style="margin-top:-10px; color:#000; font-size: 13px">Rp 2000,-</p>
                          <a href="#" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#detailfasilitas"><i class="bi bi-eye"></i></a>
                          <a href="#" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#editfasilitas"><i class="bi bi-pencil"></i></a>
                          <a href="#" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#hapusfasilitas"><i class="bi bi-trash"></i></a>
                  ...
                  <div class="col-lg-3">
                   <a href="#">
                    ...
                    <center><img src="assets/img/mic.png" class="card-img-top" style="width:50%"></center>
                        <div class="card-body">
                          <h5 class="card-title" style="color:#000; font-size: 15px" >Penghapus</h5>
                          <p style="margin-top:-10px; color:#000; font-size: 13px">Rp 2000,-</p>
                          <a href="#" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#detailfasilitas"><i class="bi bi-eye"></i></a>
                          <a href="#" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#editfasilitas"><i class="bi bi-pencil"></i></a>
                          <a href="#" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#hapusfasilitas"><i class="bi bi-trash"></i></a>
                  ...
                  <div class="col-lg-3">
                   <a href="#">
                    ...
                    <center><img src="assets/img/layar.png" class="card-img-top" style="width:50%"></center>
                        <div class="card-body">
                          <h5 class="card-title" style="color:#000; font-size: 15px" >Buku Tulis</h5>
                          <p style="margin-top:-10px; color:#000; font-size: 13px">Rp 3000,-</p>
                          <a href="#" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#detailfasilitas"><i class="bi bi-eye"></i></a>
                          <a href="#" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#editfasilitas"><i class="bi bi-pencil"></i></a>
                          <a href="#" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#hapusfasilitas"><i class="bi bi-trash"></i></a>
                        </div>
                  ...
                  <div class="col-lg-3">
                   <a href="#">
                    ...
                    <center><img src="assets/img/speaker.png" class="card-img-top" style="width:50%"></center>
                        <div class="card-body">
                          <h5 class="card-title" style="color:#000; font-size: 15px" >Penggaris</h5>
                          <p style="margin-top:-10px; color:#000; font-size: 13px">Rp 2000,-</p>
                          <a href="#" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#detailfasilitas"><i class="bi bi-eye"></i></a>
                          <a href="#" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#editfasilitas"><i class="bi bi-pencil"></i></a>
                          <a href="#" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#hapusfasilitas"><i class="bi bi-trash"></i></a>
                  ...
                  <div class="col-lg-3">
                   <a href="#">
                    ...
                    <center><img src="assets/img/kursi.png" class="card-img-top" style="width:50%"></center>
                        <div class="card-body">
                          <h5 class="card-title" style="color:#000; font-size: 15px" >Atlas</h5>
                  ...
                  <div class="col-lg-3">
                   <a href="#">
                    ...
                    <center><img src="assets/img/meja.png" class="card-img-top" style="width:50%"></center>
                        <div class="card-body">
                          <h5 class="card-title" style="color:#000; font-size: 15px" >Stipo</h5>
                          <p style="margin-top:-10px; color:#000; font-size: 13px">Rp 2000,-</p>
                          <a href="#" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#detailfasilitas"><i class="bi bi-eye"></i></a>
                          <a href="#" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#editfasilitas"><i class="bi bi-pencil"></i></a>
                          <a href="#" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#hapusfasilitas"><i class="bi bi-trash"></i></a>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
			  ...
			  <div class="row">
                <div class="col-lg-6 col-md-8 label mb-4">ambar </div>
             </div>
			 <div class="row">
                <div class="col-lg-6 col-md-8 label mb-4">mbar </div>
             </div>
            </div>
          </div>
        </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="" method="">
				...
				<div class="row mb-3">
                  <label for="fullName" class="col-md-4 col-lg-3 col-form-label">ambar</label>
                  <div class="col-md-8 col-lg-9">
                  </div>
                </div>
				<div class="row mb-3">
                  <label for="fullName" class="col-md-4 col-lg-3 col-form-label">mbar</label>
                  <div class="col-md-8 col-lg-9">
                  </div>
                </div>
              </form>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body ">
              <center>
                ...
                <a href="koperasi-koleksiproduk.php" class="btn" style="border-radius: 10px; background-color:#fff; ">Batal</a>
