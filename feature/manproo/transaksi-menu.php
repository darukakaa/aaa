...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="d-grid gap-2 d-md-block" style="margin-bottom: 30px;">
      <a class="btn" style="text-decoration: none; margin-right: 10px; box-shadow: 2px 2px 1px grey;  border-radius: 50px;" href="kantin-kelengkeng.php">Transaksi</a>
      <a class="btn" style="text-decoration: none;  box-shadow: 2px 2px 1px grey; border-radius: 50px; background-color: #2C5C52; color: white;" href="transaksi-menu.php">Transaksi</a>
    </div>
        ...
        <div class="col-lg-12 mx-auto">
          <div class="card rounded shadow border-0">
            <div class="card-body p-5 bg-white rounded">
              <button type="button" class="btn add-kelas" data-bs-toggle="modal" data-bs-target="#tambahtransaksi">Tambah Transaksi</button>
              <a href="#" class="btn add-kelas">Print Transaksi</a>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td style="width: 150px;">
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#detailtransaksi">
                          <i class="bi bi-eye-fill" style="width: 10px ;"></i>
                        </button>     
                        <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#hapustransaksi">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form>
              <div class="row mb-3">
                <label for="fullName" class="col-md-4 col-lg-3 col-form-label">No. Transaksi</label>
              ...
              <div class="row mb-3">
                <label for="Country" class="col-md-4 col-lg-3 col-form-label">Tanggal Transaksi</label>
                <div class="col-md-8 col-lg-9">
                  <input name="telepon" type="text" class="form-control" id="Telepon" value="">
                </div>
              </div>
              ...
              <div class="row mb-3">
                <label for="Phone" class="col-md-4 col-lg-3 col-form-label">Nama Pembeli</label>
                <div class="col-md-8 col-lg-9">
              ...
              <div class="row mb-3">
                <label for="Email" class="col-md-4 col-lg-3 col-form-label">Jumlah</label>
                <div class="col-md-8 col-lg-9">
              ...
              <div class="row mb-3">
                <label for="Email" class="col-md-4 col-lg-3 col-form-label">Timestamp</label>
                <div class="col-md-8 col-lg-9">
                  <input name="jabatan" type="text" class="form-control" id="Jabatan" value="">
                </div>
              </div>
    ...
    <!-- modal hapus -->
    <div class="modal fade" id="hapustransaksi" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
