...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="d-grid gap-2 d-md-block">
        ...
        <a class="btn" style="text-decoration: none; margin-right: 10px; box-shadow: 2px 2px 1px grey; background-color: #2C5C52; color: white; border-radius: 50px;" href="eksabsen.php">Absensi</a>
    </div>
                  ...
                  <table id="example" class="table table-striped " style="width:100%">
                        ...
                        <tbody>
                            ...
                            <td>Jonathan</td>
                              ...
                              <td>Alpha</td>
                              <td>-</td>
                              <td><img src="img/." alt="" width="50" height="60"></td>
                  ...
                  <div class="modal-body">
                    <form>
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-md-8 col-lg-9">
                          <input name="nisn" type="text" class="form-control" id="kelas" value="Mirna Milasari">
                        </div>
                      </div>
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-md-8 col-lg-9">
                          <input name="keterangan" type="text" class="form-control" id="ket" value="">
                        </div>
                      </div>      
            ...
            <div class="modal-body">
              <form>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <input name="telepon" type="text" class="form-control" id="status" value="">
                  </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body ">
              <center>
                ...
                <a href="eksabsen.php" class="btn" style="border-radius: 10px; background-color:#fff; ">Batal</a>
