    ...
    <div class="container table-responsive">
          ...
          <div class="col-lg-12 mx-auto">
            <div class="card rounded shadow border-0">
              <div class="card-body p-5 bg-white rounded">
                <button type="button" class="btn add-kelas" data-bs-toggle="modal" data-bs-target="#tambahsiswa">Tambah Ekstrakulikuler</button>
                            ...
                            <td>Pramuka</td>
                              ...
                              <td>250</td>
                                <td style="width: 150px;">  
                                    <a href="ekspramuka.php" type="button" class="btn btn-primary" >
              ...
              <div class="modal-dialog">
                <div class="modal-content" style="width: 650px;">
                  <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Tambah Ekstrakulikuler</h1>
                  ...
                  <div class="modal-body">
                    <form>
                      ...
                      <div class="row mb-3">
                        <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Nama Ekstrakulikuler</label>
                      ...
                      <div class="row mb-3">
                        <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Pembina</label>
                        <div class="col-md-8 col-lg-9">
                          <input name="nisn" type="text" class="form-control" id="kelas" value="">
                        </div>
                      </div>
      ...
      <div class="modal fade" id="detail" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content" style="width: 650px;">
            <div class="modal-header">
              <h1 class="modal-title fs-5" id="exampleModalLabel">Edit Ekstrakulikuler</h1>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
              <form>
                ...
                <div class="row mb-3">
                  <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Nama Ekstrakulikuler</label>
                  <div class="col-md-8 col-lg-9">
                    <input name="fullName" type="text" class="form-control" id="fullName" value="Pramuka">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <input name="nisn" type="text" class="form-control" id="nisn" value="Jonathan Cristian . M.Kom">
                  </div>
                </div>
                </div>
                <div class="text-center">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body ">
              <center>
                ...
                <a href="ekstrakulikuler.php" class="btn" style="border-radius: 10px; background-color:#fff; ">Batal</a>
