...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="d-grid gap-2 d-md-block">
        <a class="btn" style="text-decoration: none;  box-shadow: 2px 2px 1px grey; border-radius: 50px;" href="ekspramuka.php">Galeri</a>
        <a class="btn" style="text-decoration: none; margin-right: 10px; box-shadow: 2px 2px 1px grey; background-color: #2C5C52; color: white; border-radius: 50px;" href="eksjadwal.php">Jadwal</a>
    ...
    <button type="button" class="btn add-kelas" data-bs-toggle="modal" data-bs-target="#tambahsiswa">Tambah Jadwal</button>
    <button type="button" class="btn add-kelas" data-bs-toggle="modal" data-bs-target="#">Print Laporan <i class="bi bi-file-earmark-pdf-fill"></i></button>
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="width: 150px;">  
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#infoo">
                ...
                <div class="modal-content" style="width: 650px;">
                  ...
                  <div class="modal-body">
                    <form>
                      ...
                      <div class="row mb-3">
                        <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Tanggal Awal</label>
                        <div class="col-md-8 col-lg-9">
                        <div class="col-sm-10">
                      ...
                      <div class="row mb-3">
                        <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Tanggal Akhir</label>
                        <div class="col-md-8 col-lg-9">
                        <div class="col-sm-10">
                            <input type="date" class="form-control">
                        </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body ">
              <center>
                ...
                <a href="eksjadwal.php" class="btn" style="border-radius: 10px; background-color:#fff; ">Batal</a>
